...
/*
        ...
        @Test
        public void periodYearTest1(){
            simplify.year.clear();
            systemInMock.provideLines("2015","N");
            Scanner scanner= new Scanner(System.in);

            simplify.periodYear(testQuotation);
           // scanner.nextLine();
            assertThat(simplify.year).containsExactlyInAnyOrder(2015);
    }
...
/*
        simplify.year.clear();
        final ByteArrayInputStream steream = new ByteArrayInputStream(String.format("2015\nN\n").getBytes());
        System.setIn(steream);
        simplify.periodYear(testQuotation);
        assertThat(simplify.year).containsExactlyInAnyOrder(2015);
    }
*/
